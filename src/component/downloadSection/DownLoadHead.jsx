...
const DownLoadHead = () => {
  return (
    <div>
      <div className=" pb-6 max-w-[71rem] m-auto">
        <div className="flex lg:flex-row flex-col justify-between items-end gap-6 py-20">
          <div className="md:col-span-1 w-full lg:w-[30rem] px-4rem">
            <p className="text-[40px]"> Financial statements and key reports</p>
          </div>
          ...
          <div className="md:col-span-1  ">
            <div
              ...
              id="arrowanimaiton"
            >
              <p className="text-[18px] mb-2 text-[#007FAD] ">
                See all reports
              </p>
