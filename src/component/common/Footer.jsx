...
const Footer = () => {
  ...
  window.addEventListener('scroll', function () {
    ...
    if (scrollPosition > 100) { // Adjust this value according to when you want the transition to occur
  ...
  return (
    <div className={`max-w-7xl mb-6  footer m-auto py-14 px-4 z-1 md:px-12 ${isHidden ? 'hidden' : ''}`}>
      <div className="grid grid-cols-1  lg:grid-cols-4 md:grid-cols-2 gap-5 ">
        ...
        <div className=" flex flex-col sm:flex  items-center w-[100%]  lg:w-[70%] m-auto  p-4 font-semibold ">
          ...
          <p style={{ fontFamily: 'Ghawar', fontWeight: 600}} className="text-xl mt-3 text-center md:text-center font-medium mb-4 md:mb-6 uppercase ">Sectors </p>

            <span className="pb-2 text-center   "> Fossil Fuels</span>
            <span className="pb-2 text-center ">Marine Products</span>
            <span className="pb-2 text-center ">Industrial Minerals</span>
            <span className="pb-2 text-center ">Minerals and Metals</span>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex  items-center w-[100%]  lg:w-[70%] m-auto p-4 font-semibold ">
          ...
          <p style={{ fontFamily: 'Ghawar', fontWeight: 600 }} className="text-xl mt-3 text-center md:text-center font-medium mb-4 md:mb-6 uppercase">Markets </p>
        ...
        <div className="flex flex-col  sm:flex  w-[100%] items-center  lg:w-[70%] m-auto  p-4 font-semibold ">
          ...
          <div className="grid grid-cols-1 md:grid-cols-1 gap-3">
          <p style={{ fontFamily: 'Ghawar', fontWeight: 600 }} className="text-xl mt-3 text-center md:text-center font-medium mb-4 md:mb-6 uppercase">About GEROS</p>
          <Link to="/why-we-exist" className=' text-center '>
       <span onClick={scrollToTop} className="pb-2 ">Why we exist</span>
      </Link>
    ...
    <div class="flex justify-center items-center h-10 w-10 border-2 border-current rounded-full cursor-pointer group hover:border-blue-400">
      ...
      >
        <rect
          ...
          class="group-hover:stroke-blue-500"
        ></rect>
        <path d="M10.4 14.4V9.6L15.2 12L10.4 14.4Z" class="group-hover:fill-blue-500"></path>
      </svg>
    </div>
  </div>
</div>
